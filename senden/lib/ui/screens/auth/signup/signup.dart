...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void updatePhoneNumber() {
    String otpSMS = "${otpInputController_1.text}${otpInputController_2
        .text}${otpInputController_3.text}${otpInputController_4
        .text}${otpInputController_5.text}${otpInputController_6.text}";
    setState(() {
      processing = true;
    });
